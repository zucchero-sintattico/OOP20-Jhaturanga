...
public final class PiecesStyleDateStorageJsonStrategy
        extends SettingDataStorageJson<PieceStyleConfigObjectStrategy> {

    @Override
    public void setSetting(final PieceStyleConfigObjectStrategy value) throws IOException {
        this.put(SettingTypeEnum.PIECES_STYLE, value.toString());

    }

    @Override
    public Optional<PieceStyleConfigObjectStrategy> getSetting() throws IOException {
