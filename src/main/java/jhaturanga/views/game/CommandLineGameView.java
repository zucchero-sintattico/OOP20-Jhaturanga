...
public class CommandLineGameView {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final Iterator<Player> playerIt = Stream.generate(() -> List.of(whitePlayer, blackPlayer))
                .flatMap(i -> i.stream()).iterator();
        ...
        while (!match.isCompleted()) {
            ...
            do {
                ...
                if (!match.getBoard().getPieceAtPosition(new BoardPositionImpl(Integer.parseInt(origin.substring(0, 1)),
                        Integer.parseInt(origin.substring(1, 2)))).get().getPlayer().equals(playersTurn)) {
