...
public final class StartingBoardFactoryImpl implements StartingBoardFactory {
    ...
    public Board classicBoard(final Player whitePlayer, final Player blackPlayer) {
        return this.fromStringToBoard(whitePlayer, blackPlayer,
    ...
    public Board pawnHordeBoard(final Player whitePlayer, final Player blackPlayer) {
        ...
        return this.fromStringToBoard(whitePlayer, blackPlayer, whitePawnsPositions
    ...
    public Board oneDimensionBoard(final Player whitePlayer, final Player blackPlayer) {
        return this.fromStringToBoard(whitePlayer, blackPlayer, "K,0,0/N,0,1/R,0,2/k,0,7/n,0,6/r,0,5",
                ONE_D_BOARD_COLUMNS, CLASSIC_BOARD_ROWS);
    }
    ...
    public Board customizedBoard(final String startingBoard, final int columns, final int rows,
        ...
        return this.fromStringToBoard(whitePlayer, blackPlayer, startingBoard, columns, rows);
    }

    @Override
    public Board problemOneBoard(final Player whitePlayer, final Player blackPlayer) {
        return this.fromStringToBoard(whitePlayer, blackPlayer, "R,6,7/K,5,3/Q,4,3/p,2,6/k,3,6", CLASSIC_BOARD_COLUMNS,
                CLASSIC_BOARD_ROWS);
    }

    @Override
    public Board problemTwoBoard(final Player whitePlayer, final Player blackPlayer) {
        return this.fromStringToBoard(whitePlayer, blackPlayer, "P,3,6/K,5,7/k,7,7/p,7,6/n,7,5", CLASSIC_BOARD_COLUMNS,
                CLASSIC_BOARD_ROWS);
    }

    @Override
    public Board problemThreeBoard(final Player whitePlayer, final Player blackPlayer) {
        return this.fromStringToBoard(whitePlayer, blackPlayer, "k,3,0/p,2,1/B,4,0/K,5,2/Q,7,7", CLASSIC_BOARD_COLUMNS,
                CLASSIC_BOARD_ROWS);
    }
    ...
    public Board problemFiveBoard(final Player whitePlayer, final Player blackPlayer) {
        ...
        return this.fromStringToBoard(whitePlayer, blackPlayer, completeBoard, CLASSIC_BOARD_COLUMNS,
                CLASSIC_BOARD_ROWS);
    }
